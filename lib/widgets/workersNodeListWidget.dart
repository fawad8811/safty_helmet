            ...
            if (containerHeight == extendedContainerHeight)
              Row(
                ...
                children: [
                  ...
                  Text(
                    widget.workerEmergencyAlarm ? 'Activated' : 'Deactivated',
                    style: GoogleFonts.fjallaOne(
                      color: Colors.white,
                    ),
                  ),
            ...
            if (containerHeight == extendedContainerHeight)
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      openMap(widget.workerLongitude!, widget.workerLatitude!);
                    },
                    child: const Icon(
                  ...
                  onTap: () async {
                    final result = await showDialog(
                      ...
                      builder: (context) => AlertDialog(
                        title: Text(
                          'Worker Node ${widget.nodeIndex} Emergency Alarm',
                          style: GoogleFonts.fjallaOne(),
                        ),
                        content: Text(
                          'Do you want to turn ON the emergency alarm for this worker?',
                          style: GoogleFonts.fjallaOne(),
                        ),
                        actions: [
                          TextButton(
                    ...
                    if (result != null && result) {
                      try {
                        await Provider.of<AdminWorkersProvider>(context,
                            ...
                            true, widget.workerName);
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Emergency Alarm for Worker Node ${widget.nodeIndex} has been activated',
                              style: GoogleFonts.fjallaOne(),
                            ),
